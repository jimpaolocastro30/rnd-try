...
function adsPlayingIndicator(playerClassName){

	var adText = "Video will resume after the ad",
			html = '<div class="thisIsAnAd" style="position:  absolute; bottom: 50px; width: 100%; height: 54px;background:transparent;"> ' +
						 '   <div class="adsTextContainer" style="float:  right; width: 30%; text-align:  center; padding: 10px 15px; border: 1px solid #fff; background: black;"> ' +
					   '     <span style="font-size:  17px;"> '+ adText +'</span> ' +
						 '		</div> ' +
						 '</div>';

	$('.' + playerClassName).append(html);
  ...
  return {
    ...
    startLinearAdMode: function startLinearAdMode() {
      player.ads._state.startLinearAdMode();
			...
			adsPlayingIndicator('main-videojs');
    },
    ...
    endLinearAdMode: function endLinearAdMode() {
      player.ads._state.endLinearAdMode();
			...
			// REMOVE ADS INDICATOR
			$('.thisIsAnAd').fadeOut(700, function(){
				$(this).remove();
			});
    },
